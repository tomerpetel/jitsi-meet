...
class JitsiMeetContext {
    ...
    public var description: String { return "JitsiMeetContext[conferenceURL: \(conferenceURL), conferenceTimestamp: \(String(describing:conferenceTimestamp)), sessionID: \(String(describing:sessionID)), recentURLs: \(String(describing:recentURLs)), joinConferenceURL: \(String(describing:joinConferenceURL)) " }
